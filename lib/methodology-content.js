...
const content = {
  en: {
    ...
    mappingEyebrow: 'Report logic',
    mappingTitle: 'How inputs become useful outputs.',
    mappingBody:
    ...
    mappingItems: [
      ['Task exposure', 'Which recurring responsibilities are getting cheaper, faster, or easier to automate.'],
      ['Role-shape leverage', 'Whether your value comes from execution, strategy, judgment, coordination, or leadership.'],
      ['Market transfer', 'How your current credibility can move into adjacent paths without pretending you start from zero.'],
      ['Proof readiness', 'What visible evidence would make the recommendation believable to a manager or hiring team.'],
      ['Execution plan', 'What workflow to redesign first, what stays human-owned, what proof to build, and what to show in the first 7 and 30 days so the report creates movement, not just insight.'],
    ],
    sections: [
      [
  ...
  nl: {
    ...
    mappingEyebrow: 'Rapportlogica',
    mappingTitle: 'Hoe inputs nuttige output worden.',
    mappingBody:
      'PivotIQ beoordeelt je functietitel niet los. Het kijkt naar het werk dat je echt doet, hoe blootgesteld die taken zijn aan AI, welke delen van je rol hefboom creëren, en welk bewijs een veiligere volgende stap geloofwaardig maakt.',
    mappingItems: [
      ['Taakblootstelling', 'Welke terugkerende verantwoordelijkheden goedkoper, sneller of makkelijker te automatiseren worden.'],
      ['Rolvorm-hefboom', 'Of je waarde vooral komt uit uitvoering, strategie, oordeel, coördinatie of leiderschap.'],
      ['Marktoverdracht', 'Hoe je huidige geloofwaardigheid kan meebewegen naar aangrenzende paden zonder te doen alsof je vanaf nul begint.'],
      ['Bewijsbereidheid', 'Welk zichtbaar bewijs de aanbeveling geloofwaardig maakt voor een manager of hiring team.'],
      ['Uitvoeringsplan', 'Wat je in de eerste 7 en 30 dagen bouwt zodat het rapport beweging creëert, niet alleen inzicht.'],
    ],
    sections: [
      [
  ...
  de: {
    ...
    mappingEyebrow: 'Berichtslogik',
    mappingTitle: 'Wie Inputs zu nützlichen Outputs werden.',
    mappingBody:
      'PivotIQ bewertet deinen Jobtitel nicht isoliert. Es betrachtet die Arbeit, die du wirklich machst, wie stark diese Aufgaben durch KI exponiert sind, welche Teile deiner Rolle Hebel schaffen und welcher Beweis einen sichereren nächsten Schritt glaubwürdig machen würde.',
    mappingItems: [
      ['Aufgabenexposition', 'Welche wiederkehrenden Verantwortlichkeiten billiger, schneller oder leichter zu automatisieren werden.'],
      ['Rollenform-Hebel', 'Ob dein Wert aus Ausführung, Strategie, Urteil, Koordination oder Leadership entsteht.'],
      ['Markttransfer', 'Wie deine aktuelle Glaubwürdigkeit in angrenzende Wege wechseln kann, ohne so zu tun, als würdest du bei null anfangen.'],
      ['Proof-Readiness', 'Welche sichtbaren Beweise die Empfehlung für Manager oder Hiring Teams glaubwürdig machen würden.'],
      ['Umsetzungsplan', 'Was du in den ersten 7 und 30 Tagen baust, damit der Bericht Bewegung schafft, nicht nur Einsicht.'],
    ],
    sections: [
      [
