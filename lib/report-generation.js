...
const PREVIEW_OPENROUTER_MODEL = process.env.OPENROUTER_PREVIEW_MODEL || 'google/gemma-4-31b-it';
const FULL_OPENROUTER_MODEL = process.env.OPENROUTER_FULL_MODEL || process.env.OPENROUTER_MODEL || 'anthropic/claude-sonnet-4.6';
