...
function buildUserMessage(jobTitle, industry, tasks, intakeProfile, locale, stage) {
  ...
  const requirements = stage === 'preview'
    ...
    : [
        ...
        'Use decision scope and core systems to infer what environments, stakes, and tooling the user is actually close to.',
...
- Treat decision_scope and core_systems as high-signal context about the environment, stakes, and systems this user actually operates inside.
...
- Use decision scope and core systems to sharpen the role read so it feels grounded in the user's actual operating context.
...
- Use decision scope and core systems to keep pivot titles role-native and avoid drifting into generic or fantasy titles.
...
- Use decision scope and core systems to make the stay path feel native to the user's real environment.
