...
const seoMessages = {
  en: {
    home: {
      ...
      description:
        'PivotIQ is an AI career risk scanner and career pivot planner for white-collar professionals. See job automation risk by task, find credible adjacent pivots, and build a transition roadmap.',
    },
    aiCareerRisk: {
    ...
    careerPivotPlanner: {
      ...
      description:
        'Use a career pivot planner built for white-collar professionals who need credible adjacent moves, clearer skill priorities, and a practical transition roadmap.',
    },
    ...
    methodology: {
      ...
      description:
        'See how PivotIQ approaches AI career risk, task-level exposure, credible pivots, and roadmap recommendations for white-collar professionals.',
    },
    audit: {
