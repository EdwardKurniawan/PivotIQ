...
const seoMessages = {
  en: {
    home: {
      ...
      description:
        'Use PivotIQ to measure AI career risk by task, identify job automation risk in white-collar roles, and plan your next career move with a career pivot planner.',
    },
    aiCareerRisk: {
      title: 'AI Career Risk Guide for White-Collar Professionals',
      description:
        'Understand AI career risk at the task level, see which tasks in your role are getting compressed, and learn how to respond before job automation risk compounds.',
    },
    careerPivotPlanner: {
      title: 'Career Pivot Planner for White-Collar Professionals',
      description:
        'Use a career pivot planner built for white-collar professionals who need adjacent career moves, clearer skill priorities, and a practical transition roadmap.',
    },
    whiteCollarJobsAtRisk: {
      title: 'White-Collar Jobs at Risk From AI',
      description:
        'See which white-collar jobs are at risk from AI, why task mix matters more than job title alone, and how to find stronger adjacent career paths.',
    },
    methodology: {
      title: 'AI Career Risk Methodology and Scoring Logic',
      description:
        'See how PivotIQ scores AI career risk, task-level job automation exposure, adjacent career pivots, and roadmap recommendations for white-collar professionals.',
    },
    audit: {
      title: 'Free AI Career Risk Scan',
      description:
        'Run a free AI career risk scan to see which tasks in your role are getting compressed, where your human edge still compounds, and which adjacent pivots are worth exploring next.',
    },
    login: {
