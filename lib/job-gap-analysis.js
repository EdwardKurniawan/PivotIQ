...
const ROLE_NATIVE_SKILL_PATTERNS = {
  ...
  finance: /\b(finance|financial|forecast|budget|variance|pricing|modeling|planning|fp&a)\b/i,
  operations: /\b(program|project|operations|workflow|delivery|pmo|change|coordination|execution)\b/i,
