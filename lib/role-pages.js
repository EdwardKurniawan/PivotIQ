...
const content = {
  en: {
    common: {
      ...
      outputExampleEyebrow: 'Example output',
      outputExampleTitle: 'What PivotIQ would make specific in this role.',
      outputExampleBody: 'A role guide gives the general lens. The scan connects that lens to your real tasks, market direction, and proof plan.',
      outputExampleLabels: ['Exposed work', 'Defensible leverage', 'Likely adjacent paths', 'Proof to build'],
    },
    pages: {
      'marketing-manager-ai-risk': {
      ...
      'fpa-analyst-ai-risk': {
        ...
        snapshot: [
          ...
          'Credible adjacent pivots often include finance business partner, strategic finance, revenue operations, or planning roles.',
        ],
        blocks: [
        ...
        sections: [
          ...
          ['Look for pivots that keep finance credibility intact', 'Finance business partner and strategic planning roles often feel credible because they build on the same core trust.'],
      ...
      'customer-success-manager-ai-risk': {
        ...
        snapshot: [
          ...
          'Credible adjacent pivots often include account strategy, implementation leadership, revenue operations, or enablement roles.',
        ],
        blocks: [
      ...
      'recruiter-ai-risk': {
        ...
        metaDescription: 'See how AI affects recruiter roles, which tasks are most exposed, what still compounds, and which adjacent pivots remain credible.',
      ...
      'office-manager-ai-risk': {
        ...
        snapshot: [
          ...
          'Credible adjacent pivots often include operations coordinator, program operations, workplace operations, or project support roles.',
        ],
        blocks: [
      ...
      'procurement-analyst-ai-risk': {
        linkLabel: 'Procurement analyst AI risk',
        metaTitle: 'Procurement Analyst AI Risk Guide',
        metaDescription: 'See how AI affects procurement analyst roles, which sourcing and reporting tasks are most exposed, what still compounds, and which adjacent pivots make sense.',
        title: 'Procurement analyst AI risk sits in reporting and routine sourcing work before it hits decision leverage.',
        intro: 'Procurement analysts often sit inside spend reporting, supplier analysis, sourcing support, vendor documentation, and purchasing workflow coordination. AI can compress the reporting and process layer quickly, but supplier judgment, stakeholder alignment, and commercial tradeoff work retain stronger leverage.',
        snapshot: [
        ...
        blocks: [
          ['Exposure', 'The reporting and intake layer gets cheaper first', 'The role becomes more exposed when too much of the week is spent assembling vendor data, formatting sourcing updates, routing requests, and maintaining repetitive procurement workflows.'],
          ['Strength', 'Commercial judgment still matters', 'Teams still need someone who can interpret supplier tradeoffs, frame risk, and connect procurement data to real operating decisions.'],
          ['Pivot', 'The stronger paths move toward intelligence and ownership', 'The best adjacent move usually keeps your procurement context while moving you closer to sourcing strategy, analytics, or program ownership.'],
        ],
        sectionsTitle: 'How to evaluate procurement analyst exposure under AI.',
        sectionsBody: 'The important distinction is between routine procurement throughput and procurement judgment that shapes spend, supplier, and risk decisions.',
        sections: [
          ['Audit how much of the week is repetitive sourcing support', 'If your workload is dominated by intake flow, supplier spreadsheets, status updates, and recurring reporting, exposure is higher than the title alone suggests.'],
          ['Protect the supplier-decision layer', 'The work that still compounds is often the part where you weigh vendor tradeoffs, surface risk, and guide sourcing decisions for stakeholders.'],
          ['Move closer to procurement intelligence', 'Spend analytics, procurement operations, and category strategy often preserve your context while increasing defensibility.'],
          ['Build proof that changes decisions', 'The next-level signal is not just clean reporting. It is showing that your analysis changed a sourcing, supplier, or cost decision.'],
        ],
        ctaTitle: 'See whether your procurement role is centered on reporting or on decision leverage.',
        ctaBody: 'A task-level scan can show whether your procurement work is getting cheaper or moving closer to supplier judgment, analytics, and stronger ownership.',
      },
      'legal-operations-manager-ai-risk': {
        linkLabel: 'Legal operations manager AI risk',
        metaTitle: 'Legal Operations Manager AI Risk Guide',
        metaDescription: 'See how AI affects legal operations manager roles, which contract and workflow tasks are most exposed, what still compounds, and which adjacent pivots look strongest.',
        title: 'Legal operations manager AI risk rises in workflow administration before it reaches legal judgment.',
        intro: 'Legal operations managers often work across contract intake, matter coordination, vendor management, compliance workflow, reporting, and legal technology systems. AI can compress the administrative and workflow layer, but governance judgment, system design, and operational decision-making remain harder to replace.',
        snapshot: [
        ...
        blocks: [
          ['Exposure', 'Administrative legal workflow gets cheaper first', 'The role becomes more exposed when too much time goes to routing work, maintaining intake flow, packaging updates, and operating the repetitive coordination layer around legal matters.'],
          ['Strength', 'Governance still needs a human owner', 'Legal teams still need someone who can translate policy into process, manage risk across stakeholders, and decide how systems should actually operate.'],
          ['Pivot', 'The stronger paths move toward legal systems and governance ownership', 'The best adjacent moves usually keep your legal operations context while moving you closer to contract lifecycle ownership, legal technology, or compliance operations.'],
        ],
        sectionsTitle: 'How to think about legal operations exposure under AI.',
        sectionsBody: 'The core question is whether your role is mostly workflow administration or whether it is shaping how legal work, contracts, and governance systems operate.',
        sections: [
          ['Separate intake administration from governance design', 'If the week is dominated by status tracking, intake handling, and repetitive system upkeep, exposure is higher than a version of the role anchored in workflow design and policy translation.'],
          ['Protect the contract and governance layer', 'The work that compounds is often the part where you decide how contracts move, how risk is flagged, and how legal systems support the business.'],
          ['Move closer to contract lifecycle and legal tech ownership', 'Contract lifecycle, legal technology, and compliance operations roles often preserve your context while increasing defensibility.'],
          ['Build proof in systems and process outcomes', 'The strongest signal is showing that you improved legal workflow quality, cycle time, or governance visibility, not just that you kept the work moving.'],
        ],
        ctaTitle: 'See whether your legal ops role is built on admin flow or governance leverage.',
        ctaBody: 'The scan can show whether your legal operations work is getting compressed or moving toward stronger ownership in contracts, systems, and compliance workflows.',
      },
      'customer-education-manager-ai-risk': {
        linkLabel: 'Customer education manager AI risk',
        metaTitle: 'Customer Education Manager AI Risk Guide',
        metaDescription: 'See how AI affects customer education manager roles, which onboarding and content tasks are most exposed, what still compounds, and which adjacent pivots make sense.',
        title: 'Customer education manager AI risk hits repeatable content and delivery before it hits learning strategy.',
        intro: 'Customer education managers often work across onboarding content, help-center materials, training delivery, curriculum planning, LMS administration, and adoption communication. AI can compress content production and routine enablement delivery, but program design, learning systems, and adoption strategy retain stronger leverage.',
        snapshot: [
        ...
        blocks: [
          ['Exposure', 'The repeatable content layer gets cheaper first', 'The role becomes more exposed when too much of the week is spent producing repeatable training content, reworking materials, and delivering routine education motions that AI can accelerate.'],
          ['Strength', 'Program design still matters', 'Teams still need someone who can decide what customers need to learn, how programs should be measured, and how education connects to adoption and retention.'],
          ['Pivot', 'The stronger paths move toward learning systems and program ownership', 'The best adjacent moves usually keep your education context while moving you closer to learning operations, enablement strategy, or instructional system design.'],
        ],
        sectionsTitle: 'How to evaluate customer education exposure under AI.',
        sectionsBody: 'The useful distinction is between routine content production and education work that changes adoption, learning systems, and program outcomes.',
        sections: [
          ['Audit how much of the week is repeatable education delivery', 'If the role is dominated by recurring materials, basic walkthroughs, and templated enablement work, exposure is higher than the title alone suggests.'],
          ['Protect the learning-strategy layer', 'The work that compounds is often the part where you design programs, shape the learning experience, and connect education to product adoption.'],
          ['Move closer to learning operations and enablement systems', 'Learning operations, enablement programs, and instructional design often preserve your context while increasing defensibility.'],
          ['Build proof in adoption and program outcomes', 'The strongest signal is not just polished content. It is showing that your education work improved onboarding, product adoption, or learner performance.'],
        ],
        ctaTitle: 'See whether your customer education role is built on content production or program leverage.',
        ctaBody: 'A task-level scan can show whether your education work is getting compressed or moving toward stronger ownership in learning strategy, systems, and enablement outcomes.',
      },
    },
  },
  nl: {
    common: {
      ...
      outputExampleEyebrow: 'Voorbeelduitkomst',
      outputExampleTitle: 'Wat PivotIQ specifiek zou maken in deze rol.',
      outputExampleBody: 'Een rolgids geeft de algemene lens. De scan koppelt die lens aan je echte taken, marktrichting en bewijsplan.',
      outputExampleLabels: ['Blootgesteld werk', 'Verdedigbare hefboom', 'Waarschijnlijke aangrenzende paden', 'Bewijs om te bouwen'],
    },
    pages: {
      'marketing-manager-ai-risk': {
  ...
  de: {
    common: {
      ...
      outputExampleEyebrow: 'Beispielausgabe',
      outputExampleTitle: 'Was PivotIQ in dieser Rolle spezifisch machen würde.',
      outputExampleBody: 'Ein Rollenleitfaden gibt den allgemeinen Blickwinkel. Der Scan verbindet ihn mit deinen echten Aufgaben, Marktrichtung und Proof-Plan.',
      outputExampleLabels: ['Exponierte Arbeit', 'Verteidigbarer Hebel', 'Wahrscheinliche angrenzende Wege', 'Proof zum Aufbau'],
    },
    pages: {
      'marketing-manager-ai-risk': {
...
function buildRoleOutputExample(localized, page) {
  const fallback = content.en.common;
  const labels = localized.common.outputExampleLabels || fallback.outputExampleLabels;
  const snapshot = page.snapshot || [];
  const sections = page.sections || [];
  const blocks = page.blocks || [];

  return {
    eyebrow: localized.common.outputExampleEyebrow || fallback.outputExampleEyebrow,
    title: localized.common.outputExampleTitle || fallback.outputExampleTitle,
    body: localized.common.outputExampleBody || fallback.outputExampleBody,
    items: [
      [labels[0], snapshot[0] || blocks[0]?.[2] || 'The scan identifies which recurring work is most exposed.'],
      [labels[1], snapshot[1] || blocks[1]?.[2] || 'The scan separates durable judgment from compressible output.'],
      [labels[2], snapshot[2] || blocks[2]?.[2] || 'The scan ranks adjacent paths that preserve credibility.'],
      [labels[3], sections[3]?.[1] || page.ctaBody || 'The report turns the direction into visible proof someone else can review.'],
    ],
  };
}
...
export function getRolePage(locale, slug) {
  ...
  return {
    ...
    outputExample: page.outputExample || buildRoleOutputExample(localized, page),
  };
}
