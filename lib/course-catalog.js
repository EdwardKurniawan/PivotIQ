...
const SPECIFIC_RESOURCE_RULES = [
  ...
  { pattern: /\bmanager enablement\b|\bpeople operations\b|\bworkforce planning\b/i, resource_title: 'People Systems and Manager Operations', resource_url: 'https://www.coursera.org/search?query=people%20operations%20systems%20manager%20enablement', resource_provider: 'Coursera' },
  ...
  { pattern: /\bgrowth review operating system\b|\bmarketing automation governance\b|\battribution and lifecycle logic\b/i, resource_title: 'Marketing Lifecycle Operating System', resource_url: 'https://www.coursera.org/search?query=marketing%20operations%20lifecycle%20management', resource_provider: 'Coursera' },
  { pattern: /\bplanning review cadence\b|\bplanning model governance\b/i, resource_title: 'Finance Planning Operating Cadence', resource_url: 'https://www.coursera.org/search?query=finance%20planning%20operations%20cadence', resource_provider: 'Coursera' },
  { pattern: /\bmanager support operating standard\b/i, resource_title: 'People Systems and Manager Operations', resource_url: 'https://www.coursera.org/search?query=people%20operations%20systems%20manager%20enablement', resource_provider: 'Coursera' },
  { pattern: /\brenewal playbook governance\b|\bcustomer workflow orchestration\b/i, resource_title: 'Customer Renewal Playbook Systems', resource_url: 'https://www.udemy.com/courses/search/?q=customer%20success%20operations%20playbook', resource_provider: 'Udemy' },
  { pattern: /\bexception and handoff governance\b|\bteam workflow governance\b|\bexception routing logic\b/i, resource_title: 'Process Handoff Governance Design', resource_url: 'https://www.coursera.org/search?query=process%20governance%20handoff%20design', resource_provider: 'Coursera' },
  { pattern: /\bexecutive decision cadence\b|\bexecutive operating rhythm design\b/i, resource_title: 'Executive Operations and Decision Cadence', resource_url: 'https://www.coursera.org/search?query=chief%20of%20staff%20executive%20operations', resource_provider: 'Coursera' },
