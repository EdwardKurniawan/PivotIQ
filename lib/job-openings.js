...
const FUNCTION_PATTERNS = [
  ...
  { label: 'product', regex: /\bproduct\b|\broadmap\b|\bprioritization\b|\bengineering\b|\barchitecture\b/i },
];
...
function inferRoleFamily({ title = '', department = '', description = '' }) {
  const scores = {};
...
function inferDomainFocus(value) {
