  ...
  const advanced = {
    analytics: {
      ...
      governance: buildStaySearchResource({
        title: 'Analytics review and data governance paths',
        provider: 'DataCamp',
    ...
    finance: {
      workflow_design: buildStaySearchResource({
        title: 'Finance workflow design paths',
        query: 'finance workflow design scenario review',
      }),
      hard_skill: buildStaySearchResource({
        title: 'Finance modeling and planning logic paths',
    ...
    hr: {
      workflow_design: buildStaySearchResource({
        title: 'Manager enablement workflow paths',
      ...
      governance: buildStaySearchResource({
        title: 'People operations systems paths',
    ...
    customer: {
      workflow_design: buildStaySearchResource({
        title: 'Customer workflow design paths',
        provider: 'Udemy',
        query: 'customer success workflow design renewal review',
      }),
      hard_skill: buildStaySearchResource({
        title: 'Customer health and renewal analysis paths',
        provider: 'Udemy',
        query: 'customer health scoring renewal analysis',
      }),
      governance: buildStaySearchResource({
        title: 'Customer operations playbook paths',
        provider: 'Udemy',
    ...
    marketing: {
      workflow_design: buildStaySearchResource({
        title: 'Campaign workflow and experimentation paths',
        query: 'campaign experimentation workflow design',
      }),
      hard_skill: buildStaySearchResource({
        title: 'Marketing attribution and lifecycle analysis paths',
        provider: 'DataCamp',
    ...
    operations: {
      workflow_design: buildStaySearchResource({
        title: 'Workflow design and process mapping paths',
        query: 'workflow design process mapping operations',
      }),
      hard_skill: buildStaySearchResource({
        title: 'Exception routing and process control paths',
        query: 'exception routing process control operations',
      }),
      governance: buildStaySearchResource({
        title: 'Process governance and handoff design paths',
    ...
    admin: {
      workflow_design: buildStaySearchResource({
        title: 'Executive workflow design paths',
        query: 'executive workflow design chief of staff',
      }),
      hard_skill: buildStaySearchResource({
        title: 'Executive operating systems and meeting automation paths',
        query: 'executive operations meeting automation',
      }),
      governance: buildStaySearchResource({
        title: 'Executive operations and chief of staff paths',
...
function buildAdjacentStayHardSkillResource(skillName = '', roleFamily = 'general', profile = null) {
  ...
  if (/\bfinancial modeling\b|\bscenario\b|\bvariance\b|\bplanning\b|\bmodel governance\b/.test(normalized)) {
    if (/\bmodel governance\b|\bplanning review cadence\b/.test(normalized) && advancedResource) {
