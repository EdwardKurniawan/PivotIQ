...
export function buildDemoReportData(jobTitle, industry, tasks, intakeProfile = null) {
...
export function normalizeReportData(reportData, fallbackProfile = null) {
  ...
  return {
    ...
    task_breakdown: Array.isArray(reportData.task_breakdown) ? reportData.task_breakdown : [],
    ...
    next_move: {
      title: reportData.next_move?.title || 'Your move this week',
