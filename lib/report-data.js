...
function inferRoleFamilyFromProfile(jobTitle, industry, tasks = []) {
  ...
  return inferRoleFamily([jobTitle, industry, ...tasks].join(' '));
}
...
function buildHighUpsidePivotTitle(roleFamily, jobTitle, industry) {
  ...
  if (roleFamily === 'procurement') {
    return chooseDistinctTitle(
      ['Procurement Intelligence Director', 'Strategic Sourcing Director', 'Supplier Strategy Director'],
      jobTitle,
      'Procurement Intelligence Director'
    );
  }
  if (roleFamily === 'education') {
    return chooseDistinctTitle(
...
function buildStayAndAdvance(profile, summary, bestPivot, locale = 'en') {
  ...
  const roleFamily = inferRoleFamilyFromProfile(jobTitle, industry, profile?.tasks || []);
...
export function buildDemoReportData(jobTitle, industry, tasks, intakeProfile = null, locale = 'en') {
  ...
  const roleFamily = inferRoleFamilyFromProfile(jobTitle, industry, selectedTasks);
