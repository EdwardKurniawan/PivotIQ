...
export function hydrateModelReportData(reportData, fallbackProfile = null) {
  ...
  const first30Days = buildFirst30Days(profile, featuredPivot, { weeks: featuredPivot.roadmap.weeks }, reportData.next_move || fallback.next_move);
...
export function normalizeReportData(reportData, fallbackProfile = null) {
  ...
  const first30Days = buildFirst30Days(profile, defaultPivot, reportData.roadmap, reportData.next_move);
