...
function buildRecommendationStack(reportData) {
  ...
  const signalContext = primary?.type === 'stay' && broadRoleThinSignal
    ? ' Because this is a broader role family and the external signal is still thin, PivotIQ is leaning toward the safer path that converts current-role leverage into proof before betting on a bigger title change.'
    : '';
