...
function SquarePiqOne() {
  return (
    <svg width="132" height="132" viewBox="0 0 132 132" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M34 96V38H58C69.046 38 78 46.954 78 58C78 69.046 69.046 78 58 78H46" stroke={ink} strokeWidth="12" strokeLinecap="round" strokeLinejoin="round" />
...
function SquarePiqTwo() {
  return (
    <svg width="132" height="132" viewBox="0 0 132 132" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M34 96V38H58C69.046 38 78 46.954 78 58C78 69.046 69.046 78 58 78H46" stroke={cream} strokeWidth="10" strokeLinecap="round" strokeLinejoin="round" />
...
function SquarePiqThree() {
  return (
    <svg width="132" height="132" viewBox="0 0 132 132" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M34 96V38H56C68.15 38 78 47.85 78 60C78 72.15 68.15 82 56 82H46" stroke={ink} strokeWidth="12" strokeLinecap="round" strokeLinejoin="round" />
...
function SquarePiqFour() {
  return (
    <svg width="132" height="132" viewBox="0 0 132 132" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M34 96V38H56C68.15 38 78 47.85 78 60C78 72.15 68.15 82 56 82H46" stroke={cream} strokeWidth="11" strokeLinecap="round" strokeLinejoin="round" />
...
function SquarePiqFive() {
  return (
    <svg width="132" height="132" viewBox="0 0 132 132" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M34 98V38H58C71.255 38 82 48.745 82 62C82 75.255 71.255 86 58 86H46" stroke={ink} strokeWidth="13" strokeLinecap="round" strokeLinejoin="round" />
